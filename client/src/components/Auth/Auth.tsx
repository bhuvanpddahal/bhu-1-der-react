...
const Auth: React.FC = () => {
    return (
        <div className='bg-lightgrey min-h-rem flex items-center justify-center pt-3 pb-5 px-3'>
            <div className='flex max-w-3xl rounded-xl overflow-hidden shadow-large'>
                ...
                <div className='w-full flex flex-col items-center pt-3 pb-5 px-5 bg-white'>
                    ...
                    <p className='relative w-full flex items-center justify-center h-1px my-5 bg-grey'>
                    ...
                    <form className='w-full mb-2'>
                        ...
                        <div className='mb-3'>
                            ...
                            <input className='w-full border border-solid border-grey px-3 py-2 rounded-sm outline-none' type="pasword" name="password" id="password" />
                        </div>
                        <button className='w-full py-2 bg-blue-800 text-white font-medium rounded-sm' type="submit">Login</button>
                    </form>
                    <button className='w-full py-2 border border-solid border-grey rounded-sm hover:bg-lightgrey'>OR SIGNUP</button>
                </div>
            </div>
        </div>
    )
