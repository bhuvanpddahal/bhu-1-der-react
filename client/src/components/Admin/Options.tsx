...
const Options: React.FC<OptionsProp> = ({
    ...
    return (
        <div onClick={toggleShowOptions} ref={optionsRef} className='relative'>
            <MoreVertical color='#333' size={38} className='p-2 cursor-pointer rounded-full transition-bg duration-300 hover:bg-lightgrey' />
